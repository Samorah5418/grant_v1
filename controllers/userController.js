...
// //    return res.status(400).json({
// //      status: "failed",
// //      error: "Only JPEG and PNG images are allowed for image and KYC!",
// //    });
// //  }
...
//       return res.status(400).json({
//         status: "failed",
//         error: "image and KYC images are required!",
//       });
//     }
...
//       return res.status(400).json({
//         status: "failed",
//         error: "Only JPEG and PNG images are allowed for image ",
//       });
//     }
//     const imageResult = await cloudinary.uploader.upload(
//       image.tempFilePath,
